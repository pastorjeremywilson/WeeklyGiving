...
class ParagraphStyle(PropertySet):
    defaults = {
        ...
        'underlineOffset': _baseUnderlineOffset,    #fraction of font_size to offset underlines
        'underlineGap': _baseUnderlineGap,      #gap for double/triple underline
        'strikeOffset': _baseStrikeOffset,  #fraction of font_size to offset strikethrough
