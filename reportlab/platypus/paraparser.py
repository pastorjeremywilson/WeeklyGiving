...
#       <font name=font_family/fontname color=colorname size=float>
#        <span name=font_family/fontname color=colorname backcolor=colorname size=float style=stylename>
